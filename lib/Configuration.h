...
#define DEGATE_HOME "/usr/local/share/degate"
...
namespace degate {
  ...
  public:
    ...
    /**
     * Get the path to glade files and pixmaps.
     * @return If the environment variable DEGATE_HOME is set,
     *   its value. Else the default cmake-setted path is returned.
     */
